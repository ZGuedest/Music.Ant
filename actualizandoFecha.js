...
function clockTick(){
    ...
    let segundos = ("0" + ss).slice(-2);

    let fecha=(dia+"-"+date.getHours()+":"+minutos+"-"+segundos+"-"+mes+"-"+date.getFullYear())
    return fecha;
 }
//  setInterval(clockTick, 1000);
//setInterval(clockTick(), 1000);
debugger
let fechaActual =  clockTick()
function aux(){
    fechaActual =  clockTick()
    cargarMenu(arrayM)
}
setInterval(aux, 1000);//clockTick()
