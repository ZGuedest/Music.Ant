{/* <a href="Index.html"><i class="fa-solid fa-arrow-left">  ${arrayLog=[0]} </i></a>
      <div class="text-center">
        ...
        <h2 id="frase-imaginacion" class="mt-1 mb-5 pb-1">"Deja tu imaginación volar... siente la música"</h2>
      </div>
            ...
            <div id="caja" class="row g-0">
              <div class="col-lg-6">
                <div id="" class="card-body p-md-5 mx-md-4">
                  <form>
                    <p>Por favor, meta los datos de su cuenta</p>
  
                    <div class="form-outline mb-4">
                      <input type="email" id="form2Example11" class="form-control"
                        placeholder="email" pattern=".+@gmail.com" required/>
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      <input class="btn" type="submit" id="button" value="Entrar"> 
                      <a class="text-muted" href="#!">¿Has olvidado tu contraseña?</a>
                    </div>
  
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      <p class="mb-0 me-2">Si no tienes cuenta</p>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class="px-3 py-4 p-md-5 mx-md-4">
                  ...
                  <p class="small mb-0">Somos un grupo de entusiastas de la música que tiene la suerte de compartir su pasión con personas afines, guiando, aconsejando y también aprendiendo de nuestros clientes. !Bienvenidos a nuestra familia: Viva la música!</p>
                </div>
              </div>
            </div>
          </div>
